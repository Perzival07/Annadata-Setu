...
build_and_deploy brain as-brain 8002 \
  --set-env-vars "MOCK_MODE=${MOCK_MODE},GROUND_URL=${GROUND_URL},GEMINI_API_KEY=${GEMINI_API_KEY:-},GEMINI_API_KEY_1=${GEMINI_API_KEY_1:-},GEMINI_API_KEY_2=${GEMINI_API_KEY_2:-},GEMINI_API_KEY_3=${GEMINI_API_KEY_3:-},GEMINI_API_KEY_4=${GEMINI_API_KEY_4:-},ENABLE_GEMINI_TOOLS=${ENABLE_GEMINI_TOOLS:-false},GEMINI_TOOLS_BUDGET_S=${GEMINI_TOOLS_BUDGET_S:-20},GEMINI_MODEL=${GEMINI_MODEL:-}"
...
build_and_deploy channel as-channel 8001 \
  --set-env-vars "MOCK_MODE=${MOCK_MODE},GCP_PROJECT_ID=${PROJECT_ID},GROUND_URL=${GROUND_URL},BRAIN_URL=${BRAIN_URL},WHATSAPP_TOKEN=${WHATSAPP_TOKEN:-},WHATSAPP_PHONE_NUMBER_ID=${WHATSAPP_PHONE_NUMBER_ID:-},META_VERIFY_TOKEN=${META_VERIFY_TOKEN:-},DIAGNOSE_TIMEOUT_S=${DIAGNOSE_TIMEOUT_S:-90},ENABLE_TRANSLATION=${ENABLE_TRANSLATION:-false},MEDIA_ARCHIVE_BUCKET=${MEDIA_ARCHIVE_BUCKET:-},MEDIA_HASH_SALT=${MEDIA_HASH_SALT:-}"
